...
- Name: gobang.spec.ts >> 五子棋 (Gobang) >> 可以切换到在线对战模式
- Location: tests\e2e\gobang.spec.ts:19:3

# Error details

```
Error: page.goto: net::ERR_SOCKET_NOT_CONNECTED at https://chesshub.fun/?game=gobang
Call log:
